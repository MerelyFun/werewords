...
export const roleCatalog: readonly RoleDefinition[] = [
  { id: "seer", name: "先知", team: "villagers", description: "知道秘密词，帮助大家猜中并隐藏身份。", min: 1, max: 1, defaultCount: 1, nightSteps: steps("seer", "先知", "先知请睁眼，查看手机上的秘密词语，并记住它。", true) },
  { id: "werewolf", name: "狼人", team: "werewolves", description: "知道秘密词，阻碍猜词；猜中后指认先知。", min: 1, max: 3, defaultCount: 1, nightSteps: steps("werewolf", "狼人", "狼人请睁眼，辨认你的同伴，并查看手机上的秘密词语。", true) },
  { id: "villager", name: "村民", team: "villagers", description: "通过提问找出秘密词，讨论时寻找狼人。", min: 0, max: 8, defaultCount: 4, nightSteps: [] },
  { id: "minion", name: "爪牙", team: "werewolves", description: "知道狼人是谁，不知道秘密词，帮助狼人阵营。", min: 0, max: 1, defaultCount: 0, nightSteps: steps("minion", "爪牙", "爪牙请睁眼。狼人保持闭眼并竖起拇指，让爪牙辨认。爪牙不查看秘密词语。") },
  { id: "beholder", name: "观察者", team: "villagers", description: "知道先知是谁，但不知道秘密词。", min: 0, max: 1, defaultCount: 0, nightSteps: steps("beholder", "观察者", "观察者请睁眼。先知保持闭眼并竖起拇指，让观察者辨认。观察者不查看秘密词语。") },
  { id: "masons", name: "共济会成员", team: "villagers", description: "必须成对加入，夜晚互认，不知道秘密词。", min: 0, max: 2, defaultCount: 0, countStep: 2, nightSteps: steps("masons", "共济会成员", "共济会成员请睁眼，互相确认同伴。你们不查看秘密词语。") },
  { id: "thing", name: "怪物", team: "villagers", description: "轻触一位相邻玩家，让对方知道你是好人。", min: 0, max: 1, defaultCount: 0, nightSteps: steps("thing", "怪物", "怪物请睁眼，轻触左边或右边一位玩家的肩膀，让对方知道你是怪物。其他人保持闭眼。") },
];
