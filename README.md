...
已接入两个独立来源：你画我歪（乱七八糟啥都有）243词、阴间词汇大合集600词。在开局设置的“词库来源”选择，再选标准或挑战。完整原文与来源记录见[Steam词库导入](docs/STEAM_WORD_IMPORT.md)；难度为本项目整理，非Steam官方分级。

## 词库来源

开局可按“词库来源 → 难度 → 主题”选择出词范围。新增“群友派对之夜”300词（简单124／中等116／困难60），不与其他来源混抽；设置自动保存。来源与扩展方式见[群友词库接入](docs/PARTY_WORD_IMPORT.md)。
